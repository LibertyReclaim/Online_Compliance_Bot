...
TARGET_URL = "https://example.com/alaska-unclaimed-property"


def run_alaska(context: StateContext, company_data: dict[str, Any], filing_data: dict[str, Any]) -> dict[str, Any]:
    """Stubbed AK state automation runner."""
    ...
    return build_result(
        success=True,
        message="AK stub executed. Replace with real Playwright steps.",
