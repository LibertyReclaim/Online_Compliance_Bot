...
TARGET_URL = "https://example.com/california-unclaimed-property"


def run_california(context: StateContext, company_data: dict[str, Any], filing_data: dict[str, Any]) -> dict[str, Any]:
    """Stubbed CA state automation runner."""
    ...
    return build_result(
        success=True,
        message="CA stub executed. Replace with real Playwright steps.",
