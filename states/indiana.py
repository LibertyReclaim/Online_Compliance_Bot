...
TARGET_URL = "https://example.com/indiana-unclaimed-property"


def run_indiana(context: StateContext, company_data: dict[str, Any], filing_data: dict[str, Any]) -> dict[str, Any]:
    """Stubbed IN state automation runner."""
    ...
    return build_result(
        success=True,
        message="IN stub executed. Replace with real Playwright steps.",
