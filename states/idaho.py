...
TARGET_URL = "https://example.com/idaho-unclaimed-property"


def run_idaho(context: StateContext, company_data: dict[str, Any], filing_data: dict[str, Any]) -> dict[str, Any]:
    """Stubbed ID state automation runner."""
    ...
    return build_result(
        success=True,
        message="ID stub executed. Replace with real Playwright steps.",
