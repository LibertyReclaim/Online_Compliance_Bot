...
TARGET_URL = "https://example.com/arkansas-unclaimed-property"


def run_arkansas(context: StateContext, company_data: dict[str, Any], filing_data: dict[str, Any]) -> dict[str, Any]:
    """Stubbed AR state automation runner."""
    ...
    return build_result(
        success=True,
        message="AR stub executed. Replace with real Playwright steps.",
