...
TARGET_URL = "https://example.com/colorado-unclaimed-property"


def run_colorado(context: StateContext, company_data: dict[str, Any], filing_data: dict[str, Any]) -> dict[str, Any]:
    """Stubbed CO state automation runner."""
    ...
    return build_result(
        success=True,
        message="CO stub executed. Replace with real Playwright steps.",
