...
TARGET_URL = "https://example.com/connecticut-unclaimed-property"


def run_connecticut(context: StateContext, company_data: dict[str, Any], filing_data: dict[str, Any]) -> dict[str, Any]:
    """Stubbed CT state automation runner."""
    ...
    return build_result(
        success=True,
        message="CT stub executed. Replace with real Playwright steps.",
