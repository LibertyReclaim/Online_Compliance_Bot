...
TARGET_URL = "https://example.com/delaware-unclaimed-property"


def run_delaware(context: StateContext, company_data: dict[str, Any], filing_data: dict[str, Any]) -> dict[str, Any]:
    """Stubbed DE state automation runner."""
    ...
    return build_result(
        success=True,
        message="DE stub executed. Replace with real Playwright steps.",
